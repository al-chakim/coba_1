            ...
            Padding(
              ...
              child: Column(
                children: [
                  ...
                  SizedBox(height: 20,),
                  Text('Komentar', textAlign: TextAlign.left,),
                  SizedBox(height: 10,),
                  Text('Awal episode animenya dibuka dengan dramatisir. Setelah mengetahui tidak berdayanya Kirito yang kini tidak sadarkan diri, saya seperti terbawa dalam cerita, membayangkan posisi saya menjadi Kirito yang tidak berdaya, setelah itu diasuh oleh Alice Zuberg. Tentunya sangat miris jika melihat Kirito yang sekarang, karena sebelumnya ia dengan mudahnya mengalahkan musuh dengan pengalamannya sebagai gamer. Sekarang hidup dia hanya bisa bergantung pada Alice Zuberg, mantan Integrity Knight dan juga teman masa kecil Kirito dan Eugeo di dalam Underworld. Dengan kepedulian Alice terhadap Kirito yang sangat besar, saya pun tidak akan protes jika Alice dinobatkan menjadi best girl dalam anime ini.',
                  textAlign: TextAlign.justify,
                  ),
                  SizedBox(height: 30,)
                ],
